<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="角色编号" prop="roleId" align="center" width="220" />
      <el-table-column label="角色名称" prop="roleName" align="center" :show-overflow-tooltip="true" width="220" />
      <el-table-column label="权限字符" prop="roleKey" align="center" :show-overflow-tooltip="true" width="220" />
